       ...
       this.removeEventListener("click", memory.onClick);
           ...
           if (memory.TurnedOver === 2)
           {
               ...
               if (memory.firstClick.img.className === secondClick.img.className)
               {
                   ...
                   {
                       memory.ShowBox.innerHTML = "Grattis du har vunnit! Det tog dig "+memory.Tries+" försök. Tryck F5 för ny omgång";
                   }
                   memory.check = true;
               }
               else
               ...
               {
                   console.log(memory);
                 memory.ShowBox.innerHTML = "Du har hittat "+memory.PairsFound+" av "+memory.picArray.length/2+". "+memory.Tries+" Antal försök.";
               }
